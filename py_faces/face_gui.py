...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.video_frame_label, 0, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.face_detect_label, 3, 2, 1, 1)
        self.info_label = QtWidgets.QLabel(self.face_gui_centralWidget)
        self.info_label.setEnabled(True)
        self.info_label.setObjectName("info_label")
        self.gridLayout.addWidget(self.info_label, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.face_recognition_label, 4, 2, 1, 1)
